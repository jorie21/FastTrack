...
<template>
    <!-- Constrained width, centered, with enough padding for the floating badges -->
    <div class="w-full lg:flex-1 flex justify-center" aria-hidden="true">
        <div class="relative w-full max-w-[440px] mt-8 mb-8 mx-6 lg:mx-0">

            <!-- Main card -->
            <div
                class="w-full rounded-2xl p-7 backdrop-blur-xl border border-white/10 animate-slide-in-right"
            ...
            <div
                class="absolute -top-4 -right-4 flex items-center gap-2 px-4 py-2 rounded-full text-xs font-semibold text-emerald-400 border border-white/12 backdrop-blur-xl whitespace-nowrap animate-float-badge"
            ...
            <div
                class="absolute -bottom-4 -left-4 flex items-center gap-2 px-4 py-2 rounded-full text-xs font-semibold text-blue-400 border border-white/12 backdrop-blur-xl whitespace-nowrap animate-float-badge"
